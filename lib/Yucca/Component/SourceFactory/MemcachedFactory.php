...
class MemcachedFactory implements SourceFactoryInterface
{
    /**
    ...
    public function getSource($sourceName, array $params = array()) {
        ...
        $toReturn = new Memcached($sourceName, $params, isset($connectionConfig['options']['prefix']) ? $connectionConfig['options']['prefix'] : '');
